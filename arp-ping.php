...
//    $segment = mysql_fetch_object(mysql_query("SELECT * FROM segment WHERE ip = '$network'"));
    $segment = mysqli_fetch_object(mysqli_query("SELECT * FROM segment WHERE ip = '$network'"));
